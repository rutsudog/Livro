...
function renderGrafico(){
  ...
  if (typeof Chart === 'undefined'){
    // biblioteca do gráfico não carregou (ex.: sem conexão com o CDN);
    // a legenda e o total acima já foram atualizados normalmente.
    return;
  }
...
function renderTudo(){
  const secoes = [renderContas, popularCategorias, renderParcelas, renderHistorico, renderGrafico];
  secoes.forEach(fn => {
    try{ fn(); }
